...
const generalSlice = createSlice({
    ...
    reducers: {
        ...
        setResult: (state, action: {payload: GeneralState['result']}) => ({
            ...state,
...
export const { setCounter, updateCounter, setDifficulty, clearGeneral, setGameStarted, setResult } = generalSlice.actions;
